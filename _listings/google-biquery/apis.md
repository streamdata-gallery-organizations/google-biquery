...
- name: Google BigQuery API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-biquery/master/_listings/google-biquery/projects-projectid-queries-jobid-get.md
x-common:
- type: x-code
